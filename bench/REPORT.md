...
Generated 2026-07-26T21:05:43.352Z on this MacBook Pro (Chromium + WebGPU via Playwright). 12 questions (11 corpus + 1 off-topic control), identical RAG excerpts from the app's real retrieval, app's real system prompt. Judge: claude -p, rubric over groundedness / citations / helpfulness / quality (0-5 each, 20 max).
